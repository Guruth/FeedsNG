...
interface FeedRepository {
    ...
    fun getAllFeedItems(feedId: FeedId, since: Instant? = null, limit: Int? = null): Flow<FeedItem>
    fun getAllFeedItemIds(feedId: FeedId, since: Instant? = null, limit: Int? = null): Flow<FeedItemId>
